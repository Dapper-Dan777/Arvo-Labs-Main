 ...
 * 
 * @param pathname - Die aktuelle Route (z.B. "/analytics" oder "/workflows/marketing")
 * @returns CSS-Variable für den Section-Gradient (z.B. "var(--gradient-analytics)")
 */
export function getSectionGradient(pathname: string): string {
  // Prüfe exakte Matches zuerst
  if (SECTION_GRADIENTS[pathname]) {
    return SECTION_GRADIENTS[pathname];
  }
  
  // Prüfe auf Route-Prefixes (z.B. /workflows/marketing -> /workflows)
 ...
 * 
 * @param pathname - Die aktuelle Route (z.B. "/analytics" oder "/workflows/marketing")
 * @returns CSS-Variable für die Section-Box-Color (z.B. "var(--box-analytics)")
 */
export function getSectionBoxColor(pathname: string): string {
  ...
  // Fallback auf Standard Glass Card Background
 ...
 * 
 * @param pathname - Die aktuelle Route (z.B. "/analytics" oder "/workflows/marketing")
 * @returns CSS-Variable für die Section-Secondary-Color (z.B. "var(--secondary-analytics)")
 */
export function getSectionSecondaryColor(pathname: string): string {
  ...
  // Fallback auf Standard Secondary Color
  return "var(--color-text-secondary)";
}

/**
 * React Hook: Gibt den aktuellen Section-Gradient basierend auf der Location zurück
 * 
 * @returns CSS-Variable für den aktuellen Section-Gradient
 */
export function useSectionGradient(): string {
  ...
  return getSectionGradient(pathname);
}

/**
 * React Hook: Gibt die aktuelle Section-Box-Color basierend auf der Location zurück
 * 
 * @returns CSS-Variable für die aktuelle Section-Box-Color
 */
export function useSectionBoxColor(): string {
  ...
  const pathname = window.location.pathname;
  return getSectionBoxColor(pathname);
}

/**
 * React Hook: Gibt die aktuelle Section-Secondary-Color basierend auf der Location zurück
 * 
 * @returns CSS-Variable für die aktuelle Section-Secondary-Color
 */
export function useSectionSecondaryColor(): string {
  ...
  const pathname = window.location.pathname;
  return getSectionSecondaryColor(pathname);
}
